...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySQL("server=localhost;port=3306;user=root;password=Pingu3591;database=desarrollodeinterfaces");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Mecánico>(entity =>
            {
                ...
                entity.Property(e => e.EsJefe).HasColumnName("Es_Jefe");
            ...
            modelBuilder.Entity<Reparación>(entity =>
            {
                ...
                entity.HasIndex(e => e.DniCliente)
                    .HasName("DNI_Cliente3_idx");

                entity.HasIndex(e => e.DniUsuario)
                    .HasName("DNI_Usuario3_idx");
                ...
                entity.Property(e => e.Piezas).HasMaxLength(45);
            ...
            modelBuilder.Entity<Vehículo>(entity =>
            {
                ...
                entity.Property(e => e.NumSerial).HasColumnName("Num_Serial");
            ...
            modelBuilder.Entity<Venta>(entity =>
            {
                ...
                entity.Property(e => e.Plazo).HasMaxLength(45);
